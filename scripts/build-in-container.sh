#!/usr/bin/env bash
# Build this repo inside the kindle-substrate-build Docker image (linux/amd64).
#
...
IMAGE="${KSUBSTRATE_BUILD_IMAGE:-kindle-substrate-build:kpm-devkit-0.1.0}"
PLATFORM="${KSUBSTRATE_BUILD_PLATFORM:-linux/amd64}"
